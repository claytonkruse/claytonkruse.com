...
<div class="max-w-2xl">
	...
	<p>
		...
		year of college. I had already set my sights on an internship for the summer,
		but that did not work out for me.
	</p>
	<p>
		I was overqualified for the position, and only required only minimal
		training. I recieved high praise for my performence in resolving both
		hardware and software related issues, and was commended for my communication
		skills.
	</p>
	<p>
		Towards the end of the summer, I was put in charge of running the store for
		two weeks while the owner went on vacation. Upon his return, I was
	...
	<p>
		...
		hard work preparing food, cleaning, and working the closing shift. The
		difference with Dierberg's was that I was now working full time while still
		attending school, and in a position where I had to both provide customer
		service, and functionally work as a team with my co-workers, which was in
		stark contrast to the solitude of Dairy Queen. During my time at Dierberg's,
	...
	<p>
		...
		grease out back behind the dumpster and pour it into the receptacal, clean
		all surfaces including the insides of the microwaves, take out the trash,
